...
public class Pastel extends JFrame {
	...
	public Pastel(Ventas ventas) {
		...
		JLabel lblNewLabel = new JLabel("Pasteles");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				ventanaVentas.recibirProductoSeleccionado(id, true);
				dispose();
			}
		});
	...
	private void cargarProductosDesdeBD() {
	    try {
	    	R	 =conexionBD.getMyRs("pasteles");
	        while (R.next()) {
	            int id = R.getInt("id_pastel");
